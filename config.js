...
module.exports = {
    ...
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 𝘀𝘂𝗯𝗮𝗿𝘂𝘀 𝘁𝗲𝗮𝗺𝐁𝐨𝐭",
     ...
     */
    ownername: process.env.Owner_Name || "YOUR SUBARU",
    ownernumber: process.env.Owner_Number || "919614477116",
    instagramId: process.env.Insta || "lexx_lutheer_",

    /**
     * other details and parameters
     */
    author: process.env.Author || "SUBARU🌚🌙",
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://akashbain2006:lutherlex@cluster0.wtgjeuu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
    sessionId: process.env.SESSION_ID || "MXZ2bDB_Queen-Anya_2eHU=",
